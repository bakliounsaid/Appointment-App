            ...
            <div class="col-auto">
                <div class="d-flex flex-wrap gap-2 justify-content-center">
                    <button
                        ...
                        style="border-color: #FFD700; transition: 0.3s;" wire:click="$set('selectedCategory', null)">
                        {{ __('All') }}
                    </button>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="card h-100 border-0 rounded-4">
                    ...
                    <div class="card-body d-flex flex-column p-3">
                        <h6 class="card-title text-black fw-bold mb-1 fs-6">{{ $product->{'name_' . $language} }}</h6>
