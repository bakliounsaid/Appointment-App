<main class="content">
    <div class="container-fluid p-0">
        <div class="mb-3">
            <h1 class="h3 d-inline align-middle">{{ __('Edit Franchise') }}</h1>
        </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="logo-wrapper" id="logoWrapper">
                            ...
                            <input type="file" id="logo" wire:model.live ="image"
                                class="d-none @error('image') is-invalid @enderror" accept="image/*">
                            @error('image')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                            <div class="logo-preview-container gap-3 mt-3 overflow-hidden {{ $image || $franchise->logo ? 'show' : '' }}"
                                id="previewContainer">
                                @if ($image)
                                ...
                                @else
                                    <img id="logoPreview" class="logo-preview bg-white" alt="Logo preview"
                                        src="{{ asset('storage/' . $franchise->logo) }}">
                                @endif
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label for="companyName" class="form-label">{{ __('Franchise Name') }}</label>
                            <input type="text" class="form-control @error('franchise.name') is-invalid @enderror"
                                id="companyName" wire:model.defer="franchise.name"
                                placeholder="{{ __('Franchise Name') }}">
                            @error('franchise.name')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            <label for="email" class="form-label">{{ __('Franchise Email') }}</label>
                            <input type="email" class="form-control @error('franchise.email') is-invalid @enderror"
                                id="email" wire:model.defer="franchise.email"
                                placeholder="{{ __('Franchise Email') }}">
                            @error('franchise.email')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="phone-input-container col-md-6 position-relative">
                            <div class="mb-3">
                                ...
                                <div class="unified-input-group">
                                    ...
                                    <input type="tel"
                                        class="phone-number @error('franchise.phone1') is-invalid @enderror"
                                        wire:model.defer='franchise.phone1'
                                        placeholder="{{ __('Enter phone number') }}">
                                    @error('franchise.phone1')
                                        <span
                        ...
                        <div class="phone-input-container position-relative col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="unified-input-group">
                                    ...
                                    <input type="tel"
                                        class="phone-number @error('franchise.phone2') is-invalid @enderror"
                                        wire:model.defer='franchise.phone2'
                                        placeholder="{{ __('Enter phone number') }}">
                                    @error('franchise.phone2')
                                        <span
                                            class="invalid-feedback position-absolute bottom-0">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="url"
                                class="form-control @error('franchise.facebook') is-invalid @enderror" id="facebook"
                                wire:model.defer="franchise.facebook" placeholder="{{ __('Enter Facebook URL') }}">
                            @error('franchise.facebook')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="url"
                                class="form-control @error('franchise.youtube') is-invalid @enderror" id="youtube"
                                wire:model.defer="franchise.youtube" placeholder="{{ __('Enter Youtube URL') }}">
                            @error('franchise.youtube')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="url"
                                class="form-control @error('franchise.instagram') is-invalid @enderror" id="instagram"
                                wire:model.defer="franchise.instagram" placeholder="{{ __('Enter Instagram URL') }}">
                            @error('franchise.instagram')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="url" class="form-control @error('twitter') is-invalid @enderror"
                                id="twitter" wire:model.defer="franchise.twitter"
                                placeholder="{{ __('Enter Twitter URL') }}">
                            @error('franchise.twitter')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div style="border-bottom: 1px solid #e9ecef;" class="card-header">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror"
                                id="adminEmail" wire:model.defer="email" placeholder="{{ __('Admin Email') }}">
                            @error('email')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
