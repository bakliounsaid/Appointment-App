<main class="content">
    <div class="container-fluid p-0">
        <div class="mb-3">
            {{ Breadcrumbs::render('franchise.agencies.edit', $agency) }}
        </div>
        <form wire:submit.prevent="edit" class="needs-validation">
            ...
            <div style="box-shadow: 0 0.125rem 0.25rem rgba(0, 0, 0, 0.075);" class="card mb-4">
                <div style="border-bottom: 1px solid #e9ecef;" class="card-header">
                    <h5 class="card-title mb-0">{{ __('Agency Information') }}</h5>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="logo-wrapper" id="logoWrapper">
                            <span class="form-label d-block ">{{ __('Agency Logo') }}</span>
                            <label for="logo" class="upload-btn cursor-pointer">
                                {{ __('Select Agency Logo') }}
                            </label>
                            ...
                            @enderror
                            <div class="logo-preview-container gap-3 mt-3 overflow-hidden {{ $image || $agency->logo ? 'show' : '' }}"
                                id="previewContainer">
                                @if ($image)
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('agency.name') is-invalid @enderror"
                                id="name" wire:model.defer="agency.name" placeholder="{{ __('Agency Name') }}">
                            @error('agency.name')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            <label for="email" class="form-label">{{ __('Agency Email') }}</label>
                            <input type="email" class="form-control @error('agency.email') is-invalid @enderror"
                                id="email" wire:model.defer="agency.email" placeholder="{{ __('Agency Email') }}">
                            @error('agency.email')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="phone-input-container col-md-6 position-relative">
                            <div class="mb-3">
                                ...
                                <div class="unified-input-group">
                                    ...
                                    <input type="tel"
                                        class="phone-number @error('agency.phone1') is-invalid @enderror"
                                        wire:model.defer='agency.phone1' placeholder="{{ __('Enter phone number') }}">
                                    @error('agency.phone1')
                                        <span
                        ...
                        <div class="phone-input-container position-relative col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="unified-input-group">
                                    ...
                                    <input type="tel"
                                        class="phone-number @error('agency.phone2') is-invalid @enderror"
                                        wire:model.defer='agency.phone2' placeholder="{{ __('Enter phone number') }}">
                                    @error('agency.phone2')
                                        <span
                                            class="invalid-feedback position-absolute bottom-0">{{ $message }}</span>
                                    @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="url" class="form-control @error('agency.facebook') is-invalid @enderror"
                                id="facebook" wire:model.defer="agency.facebook"
                                placeholder="{{ __('Enter Facebook URL') }}">
                            @error('agency.facebook')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="url" class="form-control @error('agency.youtube') is-invalid @enderror"
                                id="youtube" wire:model.defer="agency.youtube"
                                placeholder="{{ __('Enter Youtube URL') }}">
                            @error('agency.youtube')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="url" class="form-control @error('agency.instagram') is-invalid @enderror"
                                id="instagram" wire:model.defer="agency.instagram"
                                placeholder="{{ __('Enter Instagram URL') }}">
                            @error('agency.instagram')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="url" class="form-control @error('agency.twitter') is-invalid @enderror"
                                id="twitter" wire:model.defer="agency.twitter"
                                placeholder="{{ __('Enter Twitter URL') }}">
                            @error('agency.twitter')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>

                        <div style="border-bottom: 1px solid #e9ecef;" class="card-header">
                            <h5 class="card-title mb-0">{{ __('Agency Location') }}</h5>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text"
                                class="form-control @error('address.address_one') is-invalid @enderror"
                                id="addressOne" wire:model.defer="address.address_one"
                                placeholder="{{ __('Enter Address One') }}">
                            @error('address.address_one')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text"
                                class="form-control @error('address.address_one') is-invalid @enderror"
                                id="addressTwo" wire:model.defer="address.address_one"
                                placeholder="{{ __('Enter Address Two') }}">
                            @error('address.address_two')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text"
                                class="form-control @error('address.code_postal') is-invalid @enderror"
                                id="codePostal" wire:model="address.code_postal"
                                placeholder="{{ __('Enter Postal Code') }}">
                            @error('address.code_postal')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="mb-3 col-md-4">
                            ...
                            <div class="unified-input-group">
                                <div class="w-100">
                                    <button class="country-select w-100" type="button" data-bs-toggle="dropdown"
                                        aria-expanded="false">
                                        ...
                                        @foreach ($this->countries as $country)
                                            <li tabindex="0">
                                                <label class="cursor-pointer dropdown-item country-option"
                                                    wire:click="selectCountryOption({{ $country->id }})">
                                                    <img src="{{ asset('vendor/blade-flags/country-' . strtolower($country->code) . '.svg') }}"
                                                        alt="{{ $country->name }} flag">
                                                    <span>{{ $country->name }}</span>
                                                </label>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('admin.username') is-invalid @enderror"
                                id="username"wire:model.defer="admin.username" placeholder="{{ __('Username') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" class="form-control @error('admin.email') is-invalid @enderror"
                                id="adminEmail" wire:model.defer="admin.email"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('admin.firstanme') is-invalid @enderror"
                                id="firstName" wire:model.defer="admin.firstname"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('admin.lastname') is-invalid @enderror"
                                id="lastName" wire:model.defer="admin.lastname"
