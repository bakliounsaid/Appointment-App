                ...
                <div class="card mb-4" style="box-shadow: 0 0.125rem 0.25rem rgba(0, 0, 0, 0.075);">
                    ...
                    <div class="card-body">
                        <div class="row g-3 mt-3">
                            <div class="col-md-6">
                                <label for="estimated_departure_time" style="font-weight: 500;" class="form-label">{{ __('Estimated departure time') }}</label>
                                <input type="time" class="form-control @error('flight.estimated_departure_time') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                <label for="estimated_arrival_time" style="font-weight: 500;" class="form-label">{{ __('Estimated arrival time') }}</label>
                                <input type="time" class="form-control @error('flight.estimated_arrival_time') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                <label for="departure_date" style="font-weight: 500;" class="form-label">{{ __('Departure date') }}</label>
                                <input type="date" class="form-control @error('flight.departure_date') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                <label for="arrival_date" style="font-weight: 500;" class="form-label">{{ __('Arrival date') }}</label>
                                <input type="date" class="form-control @error('flight.arrival_date') is-invalid @enderror"
                            ...
                            <div class="col-md-4">
                                <label for="flight_number" style="font-weight: 500;" class="form-label">{{ __('Flight number') }}</label>
                                <input type="text" class="form-control @error('flight.flight_number') is-invalid @enderror"
                            ...
                            <div class="col-md-4">
                                <label for="nb_places" style="font-weight: 500;" class="form-label">{{ __('Number places') }}</label>
                                <input type="number" class="form-control @error('flight.nb_places') is-invalid @enderror"
                            ...
                            <div class="col-md-4">
                                <label for="type" style="font-weight: 500;" class="form-label">{{ __('Type') }}</label>
                                <select class="form-control @error('flight.type') is-invalid @enderror" id="type" wire:model.defer="flight.type">
