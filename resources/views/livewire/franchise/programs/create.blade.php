<main class="content">
    <div class="container-fluid p-0">
        <div class="mb-3">
            {{ Breadcrumbs::render('franchise.programs.create') }}
        </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" min="1" class="form-control @error('program.nb_places') is-invalid @enderror"
                                id="nb-places" wire:model.live="program.nb_places" placeholder="{{ __('Places number') }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" class="form-control @error('program.start_date') is-invalid @enderror"
                                id="start-date" wire:model.defer="program.start_date" placeholder="{{ __('Start date') }}"
                                min="{{ date('Y-m-d') }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" step="0.01" class="form-control @error('program.min_instalment_payment') is-invalid @enderror"
                                id="min-instalment-payment" wire:model.defer="program.min_instalment_payment" placeholder="{{ __('Minimum Instalment Payment') }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" min="1" class="form-control @error('program.nb_instalments') is-invalid @enderror"
                                id="nb-instalments" wire:model.defer="program.nb_instalments" placeholder="{{ __('Number of instalments') }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" step="0.01" class="form-control @error('program.franchise_gain') is-invalid @enderror"
                                id="franchise-gain" wire:model.defer="program.franchise_gain" placeholder="{{ __('Franchise Gain') }}">
                        ...
                        <div class="col-md-12">
                            <label for="description"
                                ...
                                <textarea class="form-control plaintext" wire:model.defer='program.description'></textarea>
