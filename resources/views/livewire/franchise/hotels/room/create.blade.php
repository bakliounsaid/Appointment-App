    <main class="content">
        <div class="container-fluid p-0">
            <div class="mb-3">
                <h1 class="h3 d-inline align-middle">{{ __('New Room') }}</h1>
            </div>
                        ...
                        <div class="row g-3 mt-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('room.max_adult') is-invalid @enderror"
                                    id="Max_adult" wire:model.defer="room.max_adult"
                                    placeholder="{{ __('Max Adults') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number"
                                    class="form-control @error('room.max_children') is-invalid @enderror"
                        ...
                        <div class="row g-3 mt-3">
                            <div class="col-md-6">
                                ...
                                <select type="number" step="0.01"
                                    class="form-control @error('room.status') is-invalid @enderror" id="Status"
                                    wire:model.defer="room.status" placeholder="{{ __('Status') }}">
